(function(){
  const CLIENT='1.60.1.69893';
  const SRC={
    rogue:'https://wowforevertalents.com/abilities/rogue/',
    mage:'https://wowforevertalents.com/abilities/mage/',
    rogueTalents:'https://wowforevertalents.com/rogue/',
    mageBuild:'https://wowforevertalents.com/mage/builds/frost-18-0-33-19163a/',
  ...
  const rogue={
    ...
    'Crippling Poison':{procPct:30,slowPct:70,durationMs:12000,confidence:V,source:SRC.rogue},
    'Mind-numbing Poison':{procPct:20,castTimeIncreasePct:60,durationMs:14000,confidence:V,source:SRC.rogue}
  };
  ...
  const mage={
    ...
    'Frost Nova':{cost:145,range:10,gcdMs:1500,cooldownMs:25000,min:71,max:80,rootMs:8000,breakOnDamage:true,school:'Frost',confidence:V,source:SRC.mage},
    'Cone of Cold':{cost:555,range:10,gcdMs:1500,cooldownMs:10000,min:328,max:358,slowPct:40,slowMs:6000,spCoeff:0.135,spCoeffConfidence:P,school:'Frost',confidence:V,source:SRC.mage},
    'Ice Lance':{cost:160,range:30,gcdMs:1500,min:151,max:161,frozenMultiplier:4,spCoeff:0.143,spCoeffConfidence:P,school:'Frost',confidence:V,source:SRC.mage},
    'Ice Barrier':{cost:480,gcdMs:1500,cooldownMs:30000,absorb:819,durationMs:60000,confidence:V,source:SRC.mage},
    ...
    'Fire Blast':{cost:340,range:20,gcdMs:1500,cooldownMs:8000,min:415,max:491,spCoeff:0.429,spCoeffConfidence:P,school:'Fire',confidence:V,source:SRC.mage},
  ...
  const talents={
    Rogue:{
      ...
      'Improved Eviscerate':{evisDamageByRankPct:[0,7,14,20],confidence:V},
    ...
    Mage:{
      ...
      'Fingers of Frost':{procChanceAtRank2Pct:15,charges:2,durationMs:15000,confidence:V},
  ...
  window.WOW_FOREVER_COMBAT_DATA={
    version:'0.50-reference-combat-data',
    clientBuild:CLIENT,
