(()=>{
  ...
  function ensureCandidate(){
    if(!state.candidate){state.candidate=candidateFor(state.candidateIndex);state.evidence={tests:0,championWins:0,challengerWins:0,championScoreWeighted:0,challengerScoreWeighted:0,championHpWeighted:0,challengerHpWeighted:0};}
