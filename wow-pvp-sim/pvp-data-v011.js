(()=>{
  ...
  if(M){
    M.bonescythe2p={piecesRequired:2,healMin:90,healMax:110,ppm:1,status:'ACTIVE_IN_KERNEL',source:'WoWSims Classic sim/rogue/items_sets_pve.go — PPM: 1'};
    M.crusader={spellId:20034,strength:100,healMin:75,healMax:125,durationMs:15000,ppm:1,status:'ACTIVE_IN_KERNEL',source:'WoWSims Classic sim/common/enchant_effects.go — NewPPMManager(1.0)'};
  }
  if(rp){
    ...
    rp.verifiedNotYetActive=[];
    rp.activeDynamics=['Bonescythe 2p Invigorate 1 PPM','Crusader 1 PPM'];
  }
})();